  ...
  return (
    <>
      ...
      <Content>
        <div>
          <h3>Pizzaria</h3>
          <img src={pizza} alt="Foto de pizza" />
        </div>
        <div>
          <h3>Italiana</h3>
          <img src={massa} alt="Foto de espaguete" />
        </div>
        <div>
          <h3>Japonesa</h3>
          <img src={sushi} alt="Foto de comida japonesa" />
        </div>
      </Content>
      <Footer />
      <Container onSubmit={form.handleSubmit} className={visible ? '' : 'hide'}>
        <Overlay />
        {delivery && (
